...
void BEN::listen(bool receivedBit) {
    ...
    if (
        ...
        && !BENClass::isPrefix(this->receivedBitBuffer, this->receivedBitBuffer)) {
...
void BEN::listen(char receivedByte) {
